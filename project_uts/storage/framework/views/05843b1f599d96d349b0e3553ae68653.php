    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a href="<?php echo e(route('profile')); ?>" class="btn btn-outline-light ms-2"><i class="bi bi-person-circle me-1"></i> My Profile</a>
            </div>
        </div>
    </nav>
...
<?php /**PATH C:\Users\milhamabd\project_uts\resources\views/home.blade.php ENDPATH**/ ?>